...
<head>
    ...
    <title>KICS | Forget Password</title>
                ...
                <div class="login-form">
                    <form>
                        <div class="form-group">
                            <label><i class="menu-icon fa fa-envelope">&nbsp; &nbsp;</i>E-Mel</label>
                            <input type="email" class="form-control" placeholder="Email">
                        </div>
                        <button type="submit" class="btn btn-primary btn-flat m-b-15">Hantar</button>
