<?php
  ...
  if (isset($_GET["r_id"])){
    ...
    $sql2 = "SELECT store.store_name, requisition.r_date, requisition.r_date_use, requisition.r_purpose, requisition.r_status, requisition.v_note, requisition.v_note2 
             FROM requisition 
             INNER JOIN staff 
    ...
    <div id="right-panel" class="right-panel">
            ...
            <div class="col-sm-6">
                <div class="page-header float-left">
                    <div class="page-title text-secondary">  
                        <h1 style='font-size:12pt;'>Laman Utama&nbsp; / &nbsp;Senarai Permohonan&nbsp; / &nbsp;Rekod Permohonan </h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content mt-2"><!-- margin from content and breadcrumbs (spacing)  -->
            ...
            <div class="card border-light" style="padding:0;">
                <div class="card-body">
                       <div class="col-sm-12 ">
                            <h4 style="text-transform: uppercase;">Rekod Permohonan - #<?php echo $r_id; ?></h4><br>
                           ...
                           <table class="table table-bordered">
                            ...
                            <form action="" method="POST">
                                    ...
                                    <table class="table table-striped">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td class="text-center"><?php echo $row['req_quantity']; ?></td>
                                          <td class="text-center"><?php
                                              if ($row2['r_status'] != 'Pending'){
                                                echo $row['req_quantity_out']; 
                                              } 
                                              ?>
                                         </td>
                                          <td class="text-center"><?php
                                              if ($row2['r_status'] == 'Complete'){
                                                    echo $row['req_quantity_out2']; 
                                                  } 
                                                  ?> 
                                          </td>
                                        </tr>
                                ...
                                <br>
                                <a href="applicationList.php" class="btn btn-primary pull-right" style="margin-right: 5px;">KEMBALI</a>                              
                            </form>
