  ...
  include '../dbConfig.php';
   ...
   if(isset($_GET["app_status"])){
    ...
    $sql = "SELECT requisition.r_id, store.store_name, requisition.r_date_use, requisition.r_status, requisition.r_date    
            ...
            WHERE requisition.app_id =  '{$_SESSION['id']}' AND requisition.r_status = '$app_status'
    ...
    $sql = "SELECT requisition.r_id, store.store_name, requisition.r_date_use, requisition.r_status, requisition.r_date    
            ...
            INNER JOIN store
            ON requisition.s_id = store.store_id
            WHERE requisition.app_id =  '{$_SESSION['id']}'
            ORDER BY requisition.r_id DESC";    
    $result = mysqli_query($connection,$sql);
   }
    ...
    <div id="right-panel" class="right-panel">
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title text-secondary">  
                        <h1 style='font-size:12pt;'>Laman Utama&nbsp; / &nbsp;Senarai Permohonan </h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content mt-2"><!-- margin from content and breadcrumbs (spacing)  -->
            ...
            <div class="card border-light" style="padding:0;">
                <div class="card-body">
                       <div class="col-sm-12 ">
                        <a href="requisitionAdd.php" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>&nbsp;PERMOHONAN BARU</a>
                            <h4 style="text-transform: uppercase;">Senarai Permohonan</h4><br>
                                        ...
                                        <form action="" method="GET" enctype="multipart/form-data" class="form-horizontal">
                                          <tr>
                                             <td class="text-center">
                                                <a class="btn btn-link btn-sm" href="applicationListDetail.php?r_id=<?php echo $row['r_id']; ?>" name="id"><?php echo $row['r_id']; ?></a>
