    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default" >
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="admin.php"><img src="../css-sufee/images/logo applicant.png" alt="Logo"></a>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="../applicant/applicationList.php"> <i class="menu-icon ti-user"></i>Senarai Permohonan </a>
                    </li>
                    <li>
    ...
    <div id="right-panel" class="right-panel">
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title text-secondary">  
                        <h1 style='font-size:12pt;'>Laman Utama&nbsp; / &nbsp;Profil Pekerja </h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content mt-2"><!-- margin from content and breadcrumbs (spacing)  -->
            ...
            <div class="card border-light" style="padding:0;">
                <div class="card-body">
                       <div class="col-sm-12">
                            <h4 style="text-transform: uppercase;">Profil Pekerja</h4><br>
                                    ...
                                    <aside class="profile-nav alt">
                                        <section class="card">
                                            <div class="card-header user-header alt bg-dark">
                                                <div class="media">
                                                    <a href="#">
                                                        <img class="align-self-center rounded-circle mr-3" style="width:85px; height:85px;" alt="" src="../css-sufee/images/admin.jpg">
                                                    </a>
                                                    <div class="media-body">
                                                        <h2 class="text-light display-6"><?php echo $staff["staff_fname"]; ?></h2>
                                                        <p style="font-size: 25px;"><?php echo $staff["staff_position"];?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item">
                                                    <i class="fa fa-user"></i>&nbsp;&nbsp;&nbsp; <?php echo $staff["staff_username"]; ?>
                                                </li>
                                                <li class="list-group-item">
                                                    <i class="fa fa-envelope-o"></i>&nbsp;&nbsp;&nbsp;<?php echo $staff["staff_email"]; ?>
                                                </li>
                                                <li class="list-group-item">
                                                    <i class="fa fa-id-card-o"></i>&nbsp;&nbsp;&nbsp;<?php echo $staff["staff_ic"]; ?>
                                                </li>
                                                <li class="list-group-item">
                                                    <i class="fa fa-phone-square"></i>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $staff["staff_contact"]; ?>
                                                </li>
                                                <li class="list-group-item">
