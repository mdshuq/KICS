<?php
  ...
  include '../dbConfig.php';
   ...
   if (isset($_POST["changePhone"])){
    ...
    $sql2 = "UPDATE staff SET staff_contact = '$new_contact' WHERE staffID = '$staffID' ";
    ...
    if($result2){
        print "<script language=\"javascript\"type=\"text/javascript\">
            ...
            echo "<script>alert('Penukaran No Telefon Berjaya!');
            </script>";
    }
   else{
    ...
    <div id="right-panel" class="right-panel">
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title text-secondary">
                        <h1>Pengurusan / Tukar No Telefon</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content mt-2"><!-- margin from content and breadcrumbs (spacing)  -->
            ...
            <div class="card border-light" style="padding:0;">
                <div class="card-body">
                       <div class="col-sm-12 ">
                            <h4 style="text-transform: uppercase;">Tukar No Telefon</h4><br>

                            <div style='border-bottom:2px solid; border-bottom-color:#08082d;'></div><br> <!-- border -->

                            <form action="" onSubmit="return confirm('Tukar No Telefon ini ?');" method="post" enctype="multipart/form-data" class="form-horizontal">
                                  ...
                                  <div class="row form-group">
                                    <div class="col-sm-3 col-xs-6"><label for="text-input" class=" for-control-label pull-right">Nama Penuh</label></div>
                                    <div class="col-sm-6 col-xs-6"><input type="text"  placeholder="<?php echo $row['staff_ic']; ?>" class="form-control" disabled></div>
                                  </div>

                                  <div class="row form-group">
                                    <div class="col-sm-3 col-xs-6"><label for="text-input" class=" form-control-label pull-right">No Telefon</label></div>
                                    <div class="col-sm-6 col-xs-6"><input type="tel" name="phone" placeholder="<?php echo $row['staff_contact']; ?>" class="form-control" required></div>
                                  </div>

                                  <br><br>

                                  <input type="submit" value="TUKAR NO TELEFON" class="btn btn-primary pull-right" name="changePhone"> 
