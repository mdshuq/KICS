  ...
  include '../dbConfig.php';
   ...
   $staffID = $_SESSION['id'];
    ...
    $sql = "SELECT requisition.r_id, store.store_name, requisition.r_date_use, requisition.r_status, requisition.r_date    
            ...
            WHERE requisition.r_status =  'Complete' AND requisition.r_type = 'OUT'
      ...
      <div class="breadcrumbs">
            <div class="col-sm-6">
                <div class="page-header float-left">
                    <div class="page-title text-secondary">  
                        <h1 style='font-size:12pt;'>Laman Utama&nbsp; / &nbsp;Permohonan&nbsp; / &nbsp;Rekod Permohonan</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content mt-2"><!-- margin from content and breadcrumbs (spacing)  -->
            ...
            <div class="card border-light" style="padding:0;">
                <div class="card-body">
                       <div class="col-sm-12 ">
                            <h4 style="text-transform: uppercase;">Permohonan / Rekod Permohonan</h4><br>
                                ...
                                <?php if(mysqli_num_rows($result)>0){ ?> 
                                    ...
                                    <div class="sufee-alert alert with-close alert-info alert-dismissible fade show">
                                            <span class="badge badge-pill badge-info">Notis</span>
                                                &nbsp;&nbsp;Berikut merupakan senarai rekod permohonan pengeluaran item yang lepas.
