<?php
  ...
  include '../dbConfig.php';
   ...
   $sql = "SELECT requisition.r_id, store.store_name, requisition.r_date_use, requisition.r_status, requisition.r_date, requisition.total_cost    
            FROM requisition
            INNER JOIN store
            ON requisition.s_id = store.store_id
            WHERE requisition.r_type =  'IN'
      ...
      <div class="breadcrumbs">
            <div class="col-sm-6">
                <div class="page-header float-left">
                    <div class="page-title text-secondary">  
                        <h1 style='font-size:12pt;'>Laman Utama&nbsp; / &nbsp;Belian&nbsp; / &nbsp;Senarai Belian</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content mt-2"><!-- margin from content and breadcrumbs (spacing)  -->
            ...
            <div class="card border-light" style="padding:0;">
                <div class="card-body">
                       <div class="col-sm-12 ">
                        <a href="stockAdd.php" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>&nbsp; STOK MASUK</a>
                            <h4 style="text-transform: uppercase;">Belian / Senarai Belian</h4><br>
                                ...
                                <?php if(mysqli_num_rows($result)>0){ ?> 
                                    ...
                                    <div class="sufee-alert alert with-close alert-info alert-dismissible fade show">
                                            <span class="badge badge-pill badge-info">Notis</span>
                                                &nbsp;&nbsp;Berikut merupakan senarai rekod belian yang lepas.
                                        ...
                                        <form action="" method="GET" enctype="multipart/form-data" class="form-horizontal">
                                          <tr>
                                             <td class="text-center">
                                                <a class="btn btn-link btn-sm" href="stockIn_ListDetail.php?r_id=<?php echo $row['r_id']; ?>" name="id"><?php echo $row['r_id']; ?></a>
                                             </td>
                                            ...
                                            <td class="font-weight-bold">RM <?php echo $row['total_cost']; ?></td>
                                            <td class="text-center"><?php 
                                                    if ($row['r_status'] == 'Complete'){
