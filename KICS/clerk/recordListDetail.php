<?php
  ...
  include '../dbConfig.php';
   ...
   if (isset($_GET["r_id"])){
    ...
    $sql2 = "SELECT staff.staff_fname, staff.staff_position, store.store_name, requisition.r_date, requisition.r_date_use, requisition.r_purpose, requisition.r_status 
             FROM requisition 
             INNER JOIN staff 
            ...
            <div class="col-sm-8">
                <div class="page-header float-left">
                    <div class="page-title text-secondary">  
                        <h1 style='font-size:12pt;'>Laman Utama&nbsp; / &nbsp;Permohonan&nbsp; / &nbsp;Butiran Rekod Permohonan</h1>
                    </div>
                </div>
            </div>
        </div>
                       ...
                       <div id="print" class="col-sm-12 ">
                           ...
                           <div style='border-bottom:2px solid; border-bottom-color:#08082d;'></div><br> <!-- border -->
                            ...
                            <form action="" method="POST">
                                ...
                                <br>
                                 <button class="btn btn-primary pull-right" onClick="window.open('recordListPrint.php?id=' + <?php echo $r_id; ?>);">
                                     <span class="icon"><i class="menu-icon fa fa-print"></i>&nbsp;CETAK</span>
                                </button>
                                <a href="recordList.php" class="btn btn-outline-primary pull-right" style="margin-right: 5px;">KEMBALI</a>  
                                <!-- <input type="submit" value="CETAK" class="btn btn-primary pull-right" name="print" />                    -->
                            </form>
