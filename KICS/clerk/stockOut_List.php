<?php
  ...
  include '../dbConfig.php';
   ...
   $sql = "SELECT requisition.r_id, store.store_name, requisition.r_date_use, requisition.r_status, requisition.r_date    
            ...
            WHERE requisition.r_type =  'OUT' AND requisition.r_status = 'Lulus'
      ...
      <div class="breadcrumbs">
            <div class="col-sm-6">
                <div class="page-header float-left">
                    <div class="page-title text-secondary">  
                        <h1 style='font-size:12pt;'>Laman Utama&nbsp; / &nbsp;Permohonan&nbsp; / &nbsp;Senarai Permohonan</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content mt-2"><!-- margin from content and breadcrumbs (spacing)  -->
            ...
            <div class="card border-light" style="padding:0;">
                <div class="card-body">
                       <div class="col-sm-12 ">
                            <h4 style="text-transform: uppercase;">Permohonan / Senarai Permohonan</h4><br>
                                ...
                                <?php if(mysqli_num_rows($result)>0){ ?> 
                                    ...
                                    <div class="sufee-alert alert with-close alert-warning alert-dismissible fade show">
                                            <span class="badge badge-pill badge-warning">Peringatan</span>
                                                &nbsp;&nbsp;Sila sahkan senarai pengeluaran item di bawah !
                                        ...
                                        <form action="" method="GET" enctype="multipart/form-data" class="form-horizontal">
                                          <tr>
                                             <td class="text-center">
                                                 <a class="btn btn-link btn-sm" href="stockOut_ListDetail.php?r_id=<?php echo $row['r_id']; ?>" name="id"><?php echo $row['r_id']; ?></a>
                                            ...
                                            <td class="text-center"><?php 
                                                    if ($row['r_status'] == 'Lulus'){
                                                        echo "<span class='badge badge-info'>Menunggu Pengesahan</span>";
                                                    } 
                                ...
                                <?php } 
                                    ...
                                    <div class="sufee-alert alert with-close alert-success alert-dismissible fade show">
                                            <span class="badge badge-pill badge-success">Peringatan</span>
                                                &nbsp;&nbsp;Semua permohonan telah selesai disahkan !
                                              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                    </div>
