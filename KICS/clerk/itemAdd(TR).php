      ...
      <div class="breadcrumbs">
            <div class="col-sm-12">
                <div class="page-header float-left">
                    <div class="page-title text-secondary">  
                        <h1 style='font-size:12pt;'>Laman Utama&nbsp; / &nbsp;Senarai Item&nbsp; / &nbsp;Tambah Item&nbsp; / &nbsp;Terengganu Residence (TR)</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content mt-2"><!-- margin from content and breadcrumbs (spacing)  -->
            ...
            <div class="card border-light" style="padding:0;">
                <div class="card-body">
                       <div class="col-sm-12 ">
                            <h4 style="text-transform: uppercase;">Tambah Item / Terengganu Residence (TR)</h4><br>
                            ...
                            <div style='border-bottom:2px solid; border-bottom-color:#08082d;'></div><br> <!-- border -->
                                ...
                                <span class="badge badge-pill badge-warning">Peringatan</span>
                                    &nbsp;&nbsp;Sila pastikan item yang akan ditambah ini tiada di dalam rekod sistem !
                                     <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                         <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>

                                <form action="addItem_Process(TR).php" onsubmit="return confirm('Sila pastikan item ini tidak tersenarai di dalam senarai item Terengganu Residence (TR), teruskan proses tambah item ?');" method="post" enctype="multipart/form-data" class="form-horizontal">
                                  <div class="row form-group">
                                    <div class="col-sm-3 col-xs-6"><label for="text-input" class=" form-control-label pull-right">Item</label></div>
                                    <div class="col-sm-5 col-xs-6"><input type="text" id="text-input" name="item_name" placeholder="" class="form-control" required><!-- <small class="form-text text-muted">Nama seperti dalam kad pengenalan</small> --></div>
                                  </div>

                                  <div class="row form-group">
                                    <div class="col-sm-3 col-xs-6"><label for="text-input" class=" form-control-label pull-right">Unit</label></div>
                                    <div class="col-sm-4 col-xs-6"><input type="text" id="text-input" name="item_unit" placeholder="" class="form-control" required><small class="form-text text-muted">eg. Botol | Paket</small></div>
                                  </div>

                                  <div class="row form-group">
                                    <div class="col-sm-3 col-xs-6"><label for="text-input" class=" form-control-label pull-right">Permintaan / Tahun</label></div>
                                    <div class="col-sm-3 col-xs-6"><input type="number" min="1" id="text-input" name="item_demandYear" placeholder="" class="form-control" required><small class="form-text text-muted">Demand per year</small><small class="form-text text-muted"> eg: 100 Botol Setahun</small></div>
                                  </div>

                                  <div class="row form-group">
                                    <div class="col-sm-3 col-xs-6"><label for="text-input" class=" form-control-label pull-right">Kuantiti Semasa</label></div>
                                    <div class="col-sm-3 col-xs-6"><input type="number" min="1" id="text-input" name="item_currentQty" placeholder="" class="form-control" required></div>
                                  </div>

                                  <input type="submit" value="TAMBAH ITEM" class="btn btn-primary pull-right" name="add_item"> 
                                  <a href="itemList(TR).php" onclick="return confirm('Kembali ke senarai item ?');" class="btn btn-outline-primary pull-right" style="margin-right: 5px;">KEMBALI</a>  
                                </form>
