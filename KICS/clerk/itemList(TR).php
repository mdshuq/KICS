      ...
      <div class="breadcrumbs">
            <div class="col-sm-6">
                <div class="page-header float-left">
                    <div class="page-title text-secondary">  
                        <h1 style='font-size:12pt;'>Laman Utama&nbsp; / &nbsp;Senarai Item&nbsp; / &nbsp;Terengganu Residence (TR)</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content mt-2"><!-- margin from content and breadcrumbs (spacing)  -->
            ...
            <div class="card border-light" style="padding:0;">
                <div class="card-body">
                       <div class="col-sm-12 ">
                        <a href="itemAdd(TR).php" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>&nbsp;TAMBAH ITEM</a>
                            <h4 style="text-transform: uppercase;">Senarai Item / Terengganu Residence (TR)</h4><br>
                            ...
                            <?php
                                if(isset($_POST["searchItem"])){
                                    ...
                                    $sql2 = "SELECT * FROM item WHERE item_name LIKE '%$keyword%' AND s_id = '1' ORDER BY item_id ASC";
                                    $result = mysqli_query($connection,$sql2);
                                }

                                else{
                                    $selectsql  = "SELECT * from item where s_id = '1' ";
