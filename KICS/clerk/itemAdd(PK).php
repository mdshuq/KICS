      ...
      <div class="breadcrumbs">
            <div class="col-sm-10">
                <div class="page-header float-left">
                    <div class="page-title text-secondary">  
                        <h1 style='font-size:12pt;'>Laman Utama&nbsp; / &nbsp;Senarai Item&nbsp; / &nbsp;Tambah Item&nbsp; / &nbsp;Public Kitchen (PK)</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content mt-2"><!-- margin from content and breadcrumbs (spacing)  -->
            ...
            <div class="card border-light" style="padding:0;">
                <div class="card-body">
                       <div class="col-sm-12 ">
                            <h4 style="text-transform: uppercase;">Tambah Item / Public Kitchen (PK)</h4><br>
                          ...
                          <div style='border-bottom:2px solid; border-bottom-color:#08082d;'></div><br> <!-- border -->
                                ...
                                <form action="addItem_Process(PK).php" onsubmit="return confirm('Sila pastikan item ini tidak tersenarai di dalam senarai item Public Kitchen (PK), teruskan proses tambah item ?');" method="post" enctype="multipart/form-data" class="form-horizontal">
                                  ...
                                  <a href="itemList(PK).php" onclick="return confirm('Kembali ke senarai item ?');" class="btn btn-outline-primary pull-right" style="margin-right: 5px;">KEMBALI</a>  
                                </form>
