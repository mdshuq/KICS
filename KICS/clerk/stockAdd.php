      ...
      <div class="breadcrumbs">
            <div class="col-sm-6">
                <div class="page-header float-left">
                    <div class="page-title text-secondary">  
                        <h1 style='font-size:12pt;'>Laman Utama&nbsp; / &nbsp;Belian&nbsp; / &nbsp;Stok Masuk</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content mt-2"><!-- margin from content and breadcrumbs (spacing)  -->
            ...
            <div class="card border-light" style="padding:0;">
                <div class="card-body">
                       <div class="col-sm-12 ">
                            <h4 style="text-transform: uppercase;">Belian / Stok Masuk</h4><br>

                            <div style='border-bottom:2px solid; border-bottom-color:#08082d;'></div><br> <!-- border -->

                                <form action="stockAdd_Process.php" onSubmit="return confirm('Adakah tarikh belian betul ?');" method="post" enctype="multipart/form-data" class="form-horizontal">
                                   <div class="row form-group">
                                    <div class="col-sm-3 col-xs-6"><label for="select" class="form-control-label pull-right">Stor</label></div>
                                  ...
                                  <div class="row form-group">
                                    <div class="col-sm-3 col-xs-6"><label for="text-input" class=" form-control-label pull-right">Tarikh Belian</label></div>
                                  ...
                                  <div class="row form-group">
                                    <div class="col-sm-3 col-xs-6"><label for="text-input" class=" form-control-label pull-right">Catatan</label></div>
                                    <div class="col-sm-6 col-xs-6"><textarea type="textarea-input" rows="2" id="textarea-input" name="r_note" placeholder="eg. Belian Majlis Syura" class="form-control"></textarea><br> 
                                    </div>
                                  </div>
