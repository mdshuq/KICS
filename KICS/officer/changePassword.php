<?php
  ...
  include '../dbConfig.php';
   ...
   if (isset($_POST["changePassword"])){
    ...
    if($row['staff_password'] != $old_password){
        print "<script language=\"javascript\"type=\"text/javascript\">
                            <!--
                                window.setTimeout('window.location=\"changePassword.php\";',0);
                            //-->
                        </script>";

                        echo "<script>alert('Kata laluan lama yang dimasukkan adalah salah !');
                              </script>";
    }

    else{
        $sql2 = "UPDATE staff SET staff_password = '$new_password' WHERE staffID = '$staffID' ";
        $result2 = mysqli_query($connection, $sql2);
         ...
         if($result2){
                print "<script language=\"javascript\"type=\"text/javascript\">
                        ...
                        echo "<script>alert('Penukaran Kata Laluan Berjaya!');
                              </script>";
            }
            else{
    ...
    <div id="right-panel" class="right-panel">
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title text-secondary">
                        <h1>Pengurusan / Tukar Kata Laluan</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content mt-2"><!-- margin from content and breadcrumbs (spacing)  -->
            ...
            <div class="card border-light" style="padding:0;">
                <div class="card-body">
                       <div class="col-sm-12 ">
                            <h4 style="text-transform: uppercase;">Tukar Kata Laluan</h4><br>

                            <div style='border-bottom:2px solid; border-bottom-color:#08082d;'></div><br> <!-- border -->

                            <form action="" onSubmit="return confirm('Tukar Kata Laluan ini ?');" method="post" enctype="multipart/form-data" class="form-horizontal">
                                  <div class="row form-group">
                                    <div class="col-sm-3 col-xs-6"><label for="text-input" class=" form-control-label pull-right">Kata Laluan Semasa</label></div>
                                  ...
                                  <div class="row form-group">
                                    <div class="col-sm-3 col-xs-6"><label for="text-input" class=" form-control-label pull-right">Kata Laluan Baru</label></div>
                                        <div class="col-sm-5 col-xs-6">
                                            <div class="input-group">
                                              <div class="input-group-addon"><i class="fa fa-asterisk"></i></div>
                                  ...
                                  <input type="submit" value="TUKAR KATA LALUAN" class="btn btn-primary pull-right" name="changePassword"> 
