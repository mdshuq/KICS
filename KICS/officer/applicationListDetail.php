<?php
  ...
  if (isset($_GET["r_id"])){
    ...
    $sql = "SELECT item.item_name, requisition_detail.req_quantity, requisition_detail.req_quantity_out, item.item_current_quantity, requisition_detail.req_id
    ...
    $sql2 = "SELECT staff.staff_fname, staff.staff_position, store.store_name, requisition.r_date, requisition.r_date_use, requisition.r_purpose, requisition.r_status, requisition.v_note, requisition.v_note2
             FROM requisition 
             INNER JOIN staff 
  ...
  if (isset($_POST["changeQuantity"])){
        ...
        if ($newQuantity < $itemQuantity){
          $sql3 = "UPDATE requisition_detail SET req_quantity_out = '$newQuantity' WHERE req_id = '$req_id' ";
          ...
          if($result3){
            ...
            echo "<script>alert('Kuantiti dululuskan mestilah kurang daripada kuantiti permohonan !');
                  </script>";
            header("Refresh:0");                 
        }       
    }
      ...
      <div class="breadcrumbs">
            <div class="col-sm-10">
                <div class="page-header float-left">
                    <div class="page-title text-secondary">  
                        <h1 style='font-size:12pt;'>Laman Utama&nbsp; / &nbsp;Senarai Permohonan&nbsp; / &nbsp;Butiran Permohonan </h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content mt-2"><!-- margin from content and breadcrumbs (spacing)  -->
            ...
            <div class="card border-light" style="padding:0;">
                <div class="card-body">
                       <div class="col-sm-12 ">
                            <h4 style="text-transform: uppercase;">Butiran Permohonan - #<?php echo $r_id; ?></h4><br>
                            ...
                            <h4 style="text-transform: uppercase;">Senarai Item</h4><br>
                                ...
                                <?php if(mysqli_num_rows($result)>0){ ?> 
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="row form-group">
                                                                            ...
                                                                            <div class="col-sm-6 col-xs-6"><input type="text" name="newQuantity" value="<?php echo $row['req_quantity_out']; ?>"placeholder="" class="form-control"></div>
                                                                    </div>
                                                                    <input type="hidden" name="itemQuantity_ID" value="<?php echo $row["req_id"];?>" />
                                                                    <input type="hidden" name="itemQuantity" value="<?php echo $row["req_quantity_out"];?>" />
                                                                </div>
                                    ...
                                    <h4 class="text-danger"  style="font-style: italic;">&nbsp;* Sila ubah kuantiti diluluskan jika kuantiti tersebut berbeza dengan kuantiti permohonan !</h4>
                                ...
                                ?>
                            <form action="verificationProcess.php" onSubmit="return confirm('Mengesahkan permohonan ini?');" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <br>

                                <div style='border-bottom:2px solid; border-bottom-color:#D3D3D3;'></div><br><br>
                                <div class="row form-group">
                                    <div class="col col-md-2"><h4 style="text-transform: uppercase;">TINDAKAN</h4></div>
                                    <div class="col col-md-9">
                                      <div class="form-check ">
                                        <div class="radio">
                                          <label for="radio1" class="form-check-label ">
                                            <input type="radio" name="radios" value="Lulus" class="form-check-input" required>Lulus
                                          </label>
                                        </div>
                                        <div class="radio">
                                          <label for="radio2" class="form-check-label ">
                                            <input type="radio" name="radios" value="Gagal" class="form-check-input" required>Gagal
                                          </label>
                                        </div>
                                      </div>
                                    </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col col-md-6"><textarea name="verification_note" rows="2" placeholder="eg. Permohonan Diluluskan" class="form-control"></textarea></div>
                                </div>


                                <br><br>
                                <input type="hidden" name="r_id" value="<?php echo $r_id; ?>" />
                                <input type="submit" value="MENGESAHKAN PERMOHONAN" class="btn btn-primary pull-right" name="verify"> 
