            ...
            <div class="col-sm-6">
                <div class="page-header float-left">
                    <div class="page-title">  
                        <h1 style='font-size:12pt;'>Laman Utama&nbsp; / &nbsp;Rekod Permohonan&nbsp; / &nbsp;Butiran Rekod Permohonan </h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                       <div class="col-sm-12 ">
                            ...
                            <form action="" method="POST">
                                ...
                                <br>
                                <a href="recordList.php" class="btn btn-primary pull-right" style="margin-right: 5px;">KEMBALI</a>                              
                            </form>
