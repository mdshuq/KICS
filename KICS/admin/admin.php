<?php
  ...
  include '../dbConfig.php';
   ...
   //tidak aktif
   $sql2  = "SELECT * FROM staff WHERE staff_status='0'";
   $result2   = mysqli_query($connection, $sql2);
   $row2    = mysqli_num_rows($result2);  

    //kerani
   $sql3  = "SELECT * FROM staff WHERE staff_position='Kerani'";
   $result3   = mysqli_query($connection, $sql3);
   $row3    = mysqli_num_rows($result3);  

    //officer
   $sql4  = "SELECT * FROM staff WHERE staff_position='Pegawai'";
   $result4   = mysqli_query($connection, $sql4);
   $row4    = mysqli_num_rows($result4); 

    //pelayan
   $sql5  = "SELECT * FROM staff WHERE staff_position='Pelayan'";
   $result5   = mysqli_query($connection, $sql5);
   $row5    = mysqli_num_rows($result5); 

    //Ketua Chef
   $sql6  = "SELECT * FROM staff WHERE staff_position='Ketua Chef'";
                ...
                <div class="card-body">
                    <div class="sufee-alert alert with-close alert-warning alert-dismissible fade show">
                        <span class="badge badge-pill badge-warning">Peringatan</span>
                                &nbsp;&nbsp;Sila pastikan maklumat staf dikemaskini !
                    ...
                    <div class="row">
                            ...
                            <div class="card text-white bg-flat-color-5">
                                <div class="card-body">
                                    <div class="h1 text-muted text-right mb-4">
                                        ...
                                        <div class="h4 mb-0 text-light">AKTIF</div>
                                        <h4 class="font-weight-bold text-light">Jumlah Pekerja : <span class="count"><?php echo $row; ?></span></h4>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="card text-white bg-flat-color-4">
                                <div class="card-body">
                                    <div class="h1 text-muted text-right mb-4">
                                            <i class="ti ti-user text-light"></i>
                                        </div>

                                        <div class="h4 mb-0 text-light">Tidak Aktif</div>
                                        <h4 class="font-weight-bold text-light">Jumlah Pekerja: <span class="count"><?php echo $row2; ?></span></h4>
                                        <div class="progress progress-xs mt-3 mb-0 bg-light" style="width: 40%; height: 5px;"></div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="stat-widget-one">
                                        ...
                                        <div class="stat-content dib">
                                            <div class="stat-text">PELAYAN</div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="stat-widget-one">
                                        ...
                                        <div class="stat-content dib">
                                            <div class="stat-text">KETUA CHEF</div>
                                            <div class="stat-digit"><?php echo $row6; ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="stat-widget-one">
                                        ...
                                        <div class="stat-content dib">
                                            <div class="stat-text">KERANI</div>
